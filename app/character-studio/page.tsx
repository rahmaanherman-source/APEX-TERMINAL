  ...
  return (
    <main className="apexStudio">
      ...
      <header className="topbar">
        ...
        <span className="clock">{mounted ? '9:41 PM' : '9:41 PM'}</span>
          ...
          <div className="workarea">
            ...
            <div className="characterCanvas">
              ...
              <div className="heroPreview">
                <img className="godspeedReference" src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/B74F606A-1D51-4586-ABB7-D94A6CCA711F%281%29-SE4dKHuaOu737JUbCpRlqcRYyudsjw.png" alt="Godspeed character reference for the APEX Terminal engine" />
